...
for period in range(periods):
    mortgagePrinciplePaid[period] = -np.ppmt(monthlyRate, period, periods, mortgageAmount)
    mortgageInterestPaid[period] = -np.ipmt(monthlyRate, period, periods, mortgageAmount)
...
for i in range(LeaseUpLength2b + ConstructionLength2b + 2, LeaseUpLength2b + ConstructionLength2b + StabilizedLength2b):
    print('Month ' + str(i+1))
    ...
    print('Post Mortgage cash is ' + str(ProjectCash2b[i]))
...
ProjectCash2b[i] = ProjectCash2b[i-1] + CashFlowSchedule2b['CashFlow'][i] - (mortgagePrinciplePaid[StabilizedLength2b-1] + mortgageInterestPaid[StabilizedLength2b-1])
